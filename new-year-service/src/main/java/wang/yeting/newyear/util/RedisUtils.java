...
public class RedisUtils {
    ...
    public <T> T get(String key, Class<T> clazz) {
        ...
        return obj == null ? null : JSONUtil.toBean((String) obj, clazz);
    }
    ...
    public void set(String key, Object value, long time) {
        if (time > 0) {
            redisTemplate.opsForValue().set(key, gson.toJson(value), time, TimeUnit.SECONDS);
        } else {
            redisTemplate.opsForValue().set(key, gson.toJson(value));
        }
    }
     ...
     * @return
     */
    public void hashPutAllList(String key, Map<String, List> map) {
    ...
    public void hashPut(String key, String hashKey, Object obj) {
        redisTemplate.opsForHash().put(key, hashKey, gson.toJson(obj));
    }
     ...
     * @return
     */
    public Map<String, String> getHashStrEntries(String key) {
     ...
     * @return
     */
    public <T> T getMapToType(String key, String hashKey, Type type) {
     ...
     * @return
     */
    public Set<String> hashStrKeys(String key) {
